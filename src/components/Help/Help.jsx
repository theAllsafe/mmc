        ...
        <div className="grid grid-cols-3 p-4 gap-y-4 gap-x-4 pr-20">
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">User Guide</h1>
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              <a className="pt-7" href="/">
                <img src={Mesageicon} alt="Mesageicon" />
              </a>
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              <a className="  pt-7" href="/">
                <img src={Blockedicon} alt="Blockedicon" />
              </a>
              <h1 className="text-white font-bold text-xl">Blocked Users</h1>
              <h2 className="text-white font-medium text-lg">
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Archives</h1>
              <h2 className="text-white font-medium text-lg">
                Manage Archives
              </h2>
            </div>{" "}
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Report</h1>
              <h2 className="text-white font-medium text-lg">
                Report Offenses
              </h2>
            </div>{" "}
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Rewards</h1>
              <h2 className="text-white font-medium text-lg">
                See your Rewards
              </h2>
            </div>{" "}
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              <a className="  pt-7" href="/">
                <img src={Partnersicon} alt="Partnersicon" />
              </a>
              <h1 className="text-white font-bold text-xl">Partners</h1>
              <h2 className="text-white font-medium text-lg">
                Partner Programs
              </h2>
            </div>{" "}
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              <a className="  pt-7" href="/">
                <img src={Sponsericon} alt="Sponsericon" />
              </a>
              <h1 className="text-white font-bold text-xl">Sponsors</h1>
              <h2 className="text-white font-medium text-lg">
                Sponsor Programs
              </h2>
            </div>{" "}
