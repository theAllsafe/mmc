...
import mosqueLo from "./res/mosqueLo.svg";
...
const MosqueLogin = () => {
  ...
  const handleLogin = async () => {
    ...
    if (hideId === false) {
      await api
        .post(`user/loginWithMusjidId`, {
          musjidId: logindata.musjidId,
          password: logindata.password,
        })
        .then((res) => {
  ...
  return (
    <div className="mainCon ">
      ...
      <p className="font-bold text-2xl lg:text-3xl mb-8">Login as a Mosque</p>
        ...
        <div className={`w-full lg:pl-0 lg:w-1/2 mt-5 ${classes.form}`}>
            ...
            <>
              <div className="email text-left mt-4">
                ...
                <input
                  ...
                  maxLength="10"
                  placeholder="Please enter your mosque id"
                  required
                />
                <p className="text-sm text-red-500 pl-2 pt-1">
          ...
          {showResults === false ? (
            <>
              ...
              <p className=" text-sm font-bold pl-28 md:pl-60 lg:pl-44 xl:pl-72 pt-1">
                <i>Forgot Password?</i>
              </p>
            </>
          ) : null}
