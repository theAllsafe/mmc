...
import waqfLo from "./res/waqfLo.svg";
...
const WaqfLogin = () => {
  ...
  const handleLogin = () => {
    ...
    if (hideId === false) {
      api
        .post(`user/loginWithWaqfId`, {
          waqfId: logindata.waqfId,
          password: logindata.password,
        })
        .then((res) => {
            ...
            <>
              <div className="email text-left mt-4">
                ...
                <input
                  ...
                  maxLength="10"
                  placeholder="Please enter your waqf property id"
                  required
                />
                <p className="text-sm text-red-500 pl-2 pt-1">
