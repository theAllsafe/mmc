        ...
        <div className="grid grid-cols-3 p-4 gap-y-4 gap-x-4 pr-20">
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Devices</h1>
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Authentication </h1>
              <h2 className="text-white font-medium text-lg">
                Manage settings
              </h2>
            </div>{" "}
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Masjid</h1>
              <h2 className="text-white font-medium text-lg">
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Cache</h1>
              <h2 className="text-white font-medium text-lg">
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              <a className="  pt-7" href="/">
                <img src={Reedemicon} alt="Reedemicon" />
              </a>
              <h1 className="text-white font-bold text-xl">Redeem</h1>
              <h2 className="text-white font-medium text-lg">
                Redeem your points
              </h2>
            </div>{" "}
          ...
          <div className="h-44 w-22  border-solid border-2 border-green-300 rounded-lg">
            <div className="flex flex-col items-start pl-7 gap-2 ">
              ...
              <h1 className="text-white font-bold text-xl">Cash</h1>
              <h2 className="text-white font-medium text-lg">
                Encash your wallet
              </h2>
            </div>{" "}
