    ...
    <div className={classes.maincontainer}>
      ...
      <div className={`w-full flex lg:flex-row flex-column  ${classes.main}`}>
        ...
        <div className={`lg:w-1/2 h-full  ${classes.right}`}>
          <p className="tx pl-2 w-5/6 text-base lg:text-2xl text-right font-bold mt-16 lg:h-24 lg:pt-52">
          ...
          <div className="btnbox32 pt-20 lg:pt-52 lg:pl-60 mb-10">
            ...
            <Link
              to="/Login"
              className="btn13 px-6 py-2.5 ml-8 rounded-md text-white font-bold"
            >
              Log in
            </Link>
          </div>
