    ...
    <div className={`${classes.maincont}`}>
      ...
      <div className=" mt-14">
        <ul className="text-white font-bold flex flex-col gap-5">
          <li>
            {" "}
            <h1 className="text-3xl float-left ml-8 ">Security</h1>
          </li>
          ...
          <li>
            ...
            <div>
              <span className="absolute float-right -ml-80 pl-3">
                <LockIcon /> Repeat Password
              </span>
              <input
                type="text"
          ...
          <li>
            <span className="text-xs float-left ml-8 -mt-3 font-thin text-zinc-400">
            ...
            <div className="flex ml-8">
              ...
              <div className="">
                ...
                <div className=" flex justify-start ml-7">
                  <h1>Enable 2 factor authorization</h1>
                </div>
                <span className="text-s ml-7 float-left font-extralight text-zinc-400">
                  {" "}
